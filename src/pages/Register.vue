<template>
    ...
    <div class="bg-warning">
        <div class="jumbotron bg-success text-white text-center">
            <h2 class="lead display-3 font-weight-bold text-uppercase">Vuecord</h2>
            <hr>
            <p>It's time to ditch Skype and Raidcall</p>
            <p>No need for a key like Curse Voice</p>
        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <h2 class="text-center text-primary mb-5 display-4 ">Register</h2>
                <form>
